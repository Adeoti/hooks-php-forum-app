															...
															while($roww = $get_creator -> fetch()){
																...
																$gender = $roww['gender'];
																	if($profile_pix === "nill"){
																		...
																		//########$profpp = "<span style=\"border:2px solid #fff; display:block; font-size:30px; font-weight:bold; height:30px; margin-left:2px; width:34px; border-radius:50%; text-align:center; padding:11px; background-color:".$bg."; color:#ffffff;\">".$nameAlpha."</span>";
																	}else{
					...
					<div class="hot-bar">
						...
						<ul>
							...
							<li><a href="javascript:void(0)" title="Pop Shortcut" id="rigo" class="bar-trigger"><i class="fa fa-bars"></i></a></li>
								...
								?>
						<ul>
							<li><a href="index.php" title="go home"><i class="fa fa-home"></i> home</a></li>
						...
						<form action="search-filter.php" method="get" style="position:relative;" class="medium">
							...
							<input type="text" class="search-box" name="qkey" style="color:#fff;" placeholder="Search Discussions"/>
					...
					<div class="hot-navs">
						...
						<ul>
							...
							<span class="notific-count" id="notific-count"></span></a>
								...
								<div class="notific-pan" style="width:550px;">
									<div class="notific-header">
									&nbsp; &nbsp; &nbsp; <strong>Notifications</strong>
									</div>
									<div class="notification-body-body">
										&nbsp; &nbsp; <i class="fa fa-spinner spine"></i> Loading...
									</div>
								</div>
