...
<!DOCTYPE html>
	...
	<body>
		<?php include("toolbox.php"); ?>
			...
			<span class="ch-name">Business</span>
			<div class="ch-pannel">
				<div class="ch-sub">
					<span class="ch-handle"><a href="thread-pannel.php?channel=business&sub=start%up">Start Up</a>
					<span class="discussion-total">Discussions:34,0904</span>
					</span>
					
						<div class="description">
							A tailored forum for start-up related issues
						</div>
						<div class="ch-hot">
				...
				<div class="ch-sub">
					<span class="ch-handle"><a href="thread-pannel.php?channel=business&sub=marketing">Marketing</a>
					<span class="discussion-total">Discussions:34,0904</span>
					</span>
