			...
			<div class="wrapper loc">
				...
				?>
					...
					<?php  
						...
						<ul>
							<li><a class='btn btn-sm' href=\"about-cred.php?ref=$ref&pn=1\"><i class=\"fa fa-map-marker\"></i> About</a></li>
							<li><a class='btn btn-sm btn-primary' href=\"favourites.php?pn=1\" class=\"active\"
							><i class=\"fa fa-calendar\"></i> Favs</a></li>
					...
					?>
						...
						<!--To be altered by PHP-->
									...
									<?php
										//## Pagination Starts
											$rn = $con -> prepare("SELECT * FROM favourites WHERE pinner = ? AND status=? ORDER BY ref DESC");
												$pn = "";
												$pageNumber = "";
												$sex = "";
