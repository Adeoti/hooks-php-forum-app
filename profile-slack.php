		...
		<?php include("toolbox.php"); ?>
			...
			<div class="profile-header-cover"><br/><br/><br/><br/>
					<div class="member-special-navs">
						<a href="message-board.php"><i class="fa fa-envelope-o"></i> Messages</a>
						<a href="#"><i class="fa fa-cog"></i> Settings</a>
					</div>
				<div class="profile-pic">
					<div class="member-names">
						<strong style="color:#f3f3f3;"><?php echo $fname." ".$lname;?></strong><br/>
						***(Scholar)***
					</div><br/>
				<img src="images/profpix3.jpg"/>
					...
					<div class="member-navs">
						<ul>
							<li><a href="#" class="active"><i class="fa fa-book"></i> Threads</a></li>
							...
							<?php
								...
								{
									?>
							<li><a href="favourites.php"><i class="fa fa-calendar"></i> Favs</a></li>
			...
			<div class="wrapper">
				...
				<div class="middleFrag">
					<!--To be altered by PHP-->
													<!--Start of usage-->
									<?php
										$fetchPosts = $con -> prepare("SELECT * FROM discussion WHERE creator_ref = ? ORDER BY ref DESC");
